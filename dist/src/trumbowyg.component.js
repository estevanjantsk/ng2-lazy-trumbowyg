...
var Trumbowyg = /** @class */ (function () {
    ...
    Trumbowyg.prototype.ngOnInit = function () {
        ...
        this.loaded$ = this.trumbowygService.loaded(this.options.lang).pipe(filter(function (loaded) { return loaded; }));
        ...
        this.contentSub = this.readyToUse$.pipe(take(1))
            .pipe(switchMap(function () { return _this.content$.pipe(filter(function (content) { return !!content; })); }))
        ...
        this.updateSubscription = this.update ?
            this.readyToUse$
                .pipe(take(1), switchMap(function () { return _this.update; }))
                .subscribe(function () {
                _this.savedContent.emit(_this.trumbowygEl.trumbowyg('html'));
            }) : null;
    };
