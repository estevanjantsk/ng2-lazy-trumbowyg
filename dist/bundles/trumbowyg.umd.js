...
var TrumbowygService = /** @class */ (function () {
    ...
    TrumbowygService.prototype.loadLang = function (lang) {
        ...
        if (this.loadedLangs.indexOf(lang) < 0)
            return rxjs_observable_fromPromise.fromPromise(this.loadFiles.load(this.TRUMBOWYG_PREFIX_URL + "/langs/" + lang + ".min.js")
                .then(function () {
                _this.loadedLangs.push(lang);
                return true;
            }));
        return rxjs_observable_fromPromise.fromPromise(Promise.resolve(true));
    };
...
var Trumbowyg = /** @class */ (function () {
    function Trumbowyg(el, trumbowygService) {
        ...
        this.options = {};
        this.savedContent = new _angular_core.EventEmitter();
        this.readyToUse$ = new rxjs_ReplaySubject.ReplaySubject();
        this.content$ = new rxjs_BehaviorSubject.BehaviorSubject("");
    }
    ...
    __decorate$1([
        _angular_core.Input('togglePreview'),
