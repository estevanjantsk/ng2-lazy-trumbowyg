(function (global, factory) {
    ...
    (global = global || self, factory(global.main = {}, global.core, global.rxjs, global.operators));
    ...
    var TrumbowygService = /** @class */ (function () {
        ...
        TrumbowygService.prototype.load = function (serverPath) {
            ...
            var loadBasicFiles$ = window && window["jQuery"] && window["jQuery"]().on ?
                rxjs.from((_a = this.loadFiles).load.apply(_a, trumbowygFiles))
                : rxjs.from(this.loadFiles.load(JQUERY_SCRIPT_URL))
                    .pipe(operators.switchMap(function () {
                    var _a;
                    return rxjs.from((_a = _this.loadFiles).load.apply(_a, trumbowygFiles));
                }));
            var loadFiles$ = loadBasicFiles$
                .pipe(operators.switchMap(function () {
                var _a;
                return rxjs.from((_a = _this.loadFiles).load.apply(_a, trumbowygPlugInFiles))
                    .pipe(operators.catchError(function (err) { return rxjs.of(err); }));
            }));
            this.isLoaded$ = loadFiles$
                .pipe(operators.map(function () { return true; }), operators.publishReplay(1), operators.refCount());
        };
        ...
        TrumbowygService.prototype.loadLang = function (lang) {
            ...
            if (this.loadedLangs.indexOf(lang) < 0)
                return rxjs.from(this.loadFiles.load(this.TRUMBOWYG_PREFIX_URL + "/langs/" + lang + ".min.js")
                    .then(function () {
                    _this.loadedLangs.push(lang);
                    return true;
                }));
            return rxjs.from(Promise.resolve(true));
        };
        ...
        TrumbowygService = __decorate$1([
            core.Injectable(),
            __param(1, core.Optional()),
            __metadata$1("design:paramtypes", [LoadExternalFiles,
                TrumbowygConfig])
        ], TrumbowygService);
    ...
    var Trumbowyg = /** @class */ (function () {
        function Trumbowyg(el, trumbowygService) {
            ...
            this.options = {};
            this.savedContent = new core.EventEmitter();
            this.readyToUse$ = new rxjs.ReplaySubject();
            this.content$ = new rxjs.BehaviorSubject("");
        }
        ...
        Trumbowyg.prototype.ngOnInit = function () {
            ...
            this.loaded$ = this.trumbowygService.loaded(this.options.lang).pipe(operators.filter(function (loaded) { return loaded; }));
            ...
            this.contentSub = this.readyToUse$.pipe(operators.take(1))
                .pipe(operators.switchMap(function () { return _this.content$.pipe(operators.filter(function (content) { return !!content; })); }))
            ...
            this.updateSubscription = this.update ?
                this.readyToUse$
                    .pipe(operators.take(1), operators.switchMap(function () { return _this.update; }))
                    .subscribe(function () {
                    _this.savedContent.emit(_this.trumbowygEl.trumbowyg('html'));
                }) : null;
        };
        ...
        __decorate$2([
            core.Input(),
            __metadata$2("design:type", rxjs.Observable)
    ...
    var TrumbowygModule = /** @class */ (function () {
        ...
        TrumbowygModule = TrumbowygModule_1 = __decorate$3([
            core.NgModule({
                imports: [],
